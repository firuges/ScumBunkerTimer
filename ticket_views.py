...
class CloseTicketView(BaseTicketView):
    ...
    async def close_ticket(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            ...
            confirm_view = ConfirmCloseView(self.ticket_system, self.ticket_data)
        ...
        try:
            ...
            if success:
                embed = discord.Embed(
                    ...
                    description="El ticket ha sido cerrado exitosamente. Este canal se eliminará en 5 segundos.",
                    color=discord.Color.green()
                )
                await self._safe_send(interaction, embed=embed)
            else:
